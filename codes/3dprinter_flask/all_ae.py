...
# === Model Load ===
model_path = r"C:\Users\djeri\OneDrive\Desktop\3d_printing_loop\OneDrive_2025-01-13\01. CODES\01. AI CODES\AE signals\class_bi.h5"
...
local_tsv_path = r"C:\Users\djeri\OneDrive\Desktop\3d_printing_loop\AE\ae_hits.tsv"
desired_order = [
...
def update_geometry_plot():
    while True:
        ...
        plt.savefig(r"C:\Users\djeri\OneDrive\Desktop\3dprinter_flask\static\plot2.png")
        time.sleep(1)
...
def process_record(record):
    ...
    plt.savefig(r"C:\Users\djeri\OneDrive\Desktop\3dprinter_flask\static\plot1.png")
...
def stream_from_pi():
    ...
    ssh.connect("150.250.209.49", username="pi", password="1234")
